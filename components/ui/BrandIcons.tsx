/**
 * Brand marks for the company's own profiles and chat channels. lucide-react
 * dropped its brand icons, so these are inline paths — no extra dependency and
 * nothing to load at runtime.
 *
 * Each renders at currentColor and fills the box it is given.
 */

type IconProps = { className?: string };

function Glyph({ className, path, label }: IconProps & { path: string; label: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
